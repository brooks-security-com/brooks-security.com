...
This is my homelab virtualization environment. It gives me clean KVM and LXC workflows, solid snapshots and backups, and none of the licensing pain. It is open source, stable, and straightforward once it is set up. Here's a [link](https://www.proxmox.com/en/) if you aren't familiar.
...
Used in production as a reverse proxy and TLS edge. Automatic HTTPS and simple configuration make it easy to run and maintain with Ansible and config-as-code workflows. Here's a [link](https://caddyserver.com/) if you aren't familiar. Great for when ALB is too much overhead.
...
Bash handles the ad-hoc work that does not justify a full Ansible workflow. [This xkcd](https://xkcd.com/1205/) is relevant.
...
[Groq](https://groq.com/) (with a Q) is useful when I need fast API-based inference inside Python and automation workflows. It is easy to wire into internal tooling and fast enough for practical scripting loops.
...
I spend a lot of time building containers, so yes: Linux turtles all the way down. [This xkcd](https://xkcd.com/456/) is relevant.
