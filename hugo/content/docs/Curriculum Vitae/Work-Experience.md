...
I am a CISSP and Red Hat Certified Engineer specializing in delivering robust security and infrastructure solutions for clients with complex workloads. With nearly a decade of experience across the full breadth of the security lifecycle, my focus is on leaving clients secure, compliant, and satisfied. My expertise spans everything from leading successful SOC 2 compliance programs and architecting scalable AWS environments, to deep systems engineering, automation, and contract negotiation. I have successfully driven significant improvements for organizations across SaaS, critical infrastructure, government, education, and banking. I have hands-on experience with almost every aspect of defensive security and operations—from building security programs from the ground up to passing rigorous audits with zero findings. I don't do red-team pentesting; instead, my entire focus is on building, securing, and maintaining the resilient infrastructure that keeps businesses running smoothly.
